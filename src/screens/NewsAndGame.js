      ...
      <div className='newspagecontainer'>
        ...
        <div className='game-container'>
          <h3 className='title-game'>
            " Trouver votre nom de super-vilain avec vos initiales ! "
          </h3>
          <div className='game'>
            <div className='game-body'>
              ...
              <div className='firstletterlastname'>
                <label className='game-input'>
                  Première lettre de votre nom
                  <input
                    className='lastname'
                    type='text'
                    name='first letter last'
                    minLength='1'
                    maxLength='1'
                  ></input>
                </label>
              </div>
              <button className='valide-name' type='submit'>
                Valider !
              </button>
            </div>
          </div>
