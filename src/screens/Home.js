...
const Home = () => (
  <div className='home-container'>
    <Header />
    <div className='home'>
      <h3>" Vous souhaitez recruter des super-vilain ? <br/>Inscrivez-vous et faites votre choix ! "</h3>
      <h3>" Vous souhaitez intégrer notre catalogue de super-vilain ? <br/>Inscrivez-vous et passez le test ! "</h3>
