            ...
            <div className={`menu__burger ${showLinks ? "show-burger" : "hide-nav"} `} >
                <ul className="menu__links">
                    ...
                    <li className="menu__item slideInLeft-2">
                        <Link to="/news-jeux" className='menu__link'>News | Jeux</Link>
                    </li>
                    <li className="menu__item slideInLeft-3">
                        <Link to="/qui-sommme-nous?" className='menu__link'>Qui somme-nous ?</Link>
                    </li>
                ...
                <h1 className="title-home">THE <span className="red">DEAD</span> <span className="blue">AGENCY</span></h1>
        </div>
    </>
    )
}
