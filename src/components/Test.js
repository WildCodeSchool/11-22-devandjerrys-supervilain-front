...
setResult((parseInt(question1) + parseInt(question2) + parseInt(question3) + parseInt(question4)  + parseInt(question5)) *5)
setCountActive(true)
...
return (
    <>
    <div>
        <h1 className='title-page-test'>The Dead Agency - Inscritpion / Connexion</h1>
    ...
    <div className='Card-container'>
        <div className="Card-Test">
            ...
            <div className="bloc-bouton" onChange={(e)=>setQuestion1(e.target.value)}>    
                ...
                <div className='cadre-question'> 
                <li className="Question">
                    Question 2 : quel est ton but final ? </li>
                    <select className='reponse-select' value={question2} onChange={(e)=>setQuestion2(e.target.value)}>
                ...
                <div className='cadre-question'> 
                <li className="Question">
                    Question 3 : Prenez-vous du plaisir dans vos actions ? </li>
                    <div className="bloc-bouton" onChange={(e)=>setQuestion3(e.target.value)}>    
                    <input type="radio" name="q3" value= "4"></input>
                    <label for="q3Yest">Yes</label>
                ...
                <div className='cadre-question'> 
                <li className="Question">
                    Question 4 : quel arme choisirait tu ? </li>
                    <select className='reponse-select' value={question4} onChange={(e)=>setQuestion4(e.target.value)}>
                        <option value="-1">--Choisis une réponse--</option>
                ...
                <div className='cadre-question'> 
                <li className="Question">
                    Question 5 : As tu des alliés ? </li>
                    <div className="bloc-bouton" onChange={(e)=>setQuestion5(e.target.value)}>    
                    <input type="radio"name="q5" value= "0"></input>
                    <label for="q5Yest">Yes</label>
