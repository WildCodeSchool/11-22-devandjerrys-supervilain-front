...
const [question5, setQuestion5] = useState("");
    ...
    const handleSubmit = () => {
        ...
        const result = (parseInt(question1) + parseInt(question2) + parseInt(question3) + parseInt(question4)  + parseInt(question5)) *4 
        console.log(result);
    }
    ...
    <div className="Test-hover">
        <div className="Card-Test">
            ...
            <div className="bloc-bouton" onChange={(e)=>setQuestion1(e.target.value)}>    
                ...
                <li className="Question">
                    Question 2 : Sauverais-tu un homme suspendu dans le vide ? </li>
                ...
                <li className="Question">
                    Question 3 : Sauverais-tu un homme suspendu dans le vide ? </li>
                ...
                <li className="Question">
                    Question 4 : Sauverais-tu un homme suspendu dans le vide ? </li>
                    <select value={question4} onChange={(e)=>setQuestion4(e.target.value)}>
                        <option value="0">--Choisis une réponse--</option>
                ...
                <li className="Question">
                    Question 5 : Sauverais-tu un homme suspendu dans le vide ? </li>
